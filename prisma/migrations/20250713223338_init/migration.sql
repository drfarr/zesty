...
-- CreateIndex
CREATE INDEX "ingredients_bbe_date_idx" ON "ingredients"("bbe_date");
...
-- AddForeignKey
ALTER TABLE "ingredients" ADD CONSTRAINT "ingredients_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
